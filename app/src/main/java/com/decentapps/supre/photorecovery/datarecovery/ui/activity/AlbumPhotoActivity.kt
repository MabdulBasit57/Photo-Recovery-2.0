...
import com.decentapps.supre.photorecovery.datarecovery.adapter.AlbumsPhotoAdapter

class AlbumPhotoActivity : AppCompatActivity(), AlbumsPhotoAdapter.OnClickItemListener {
    var adapter: AlbumsPhotoAdapter? = null
    ...
    public override fun onCreate(bundle: Bundle?) {
     ...
     /*   val mAdView = findViewById<AdView>(R.id.madView)
        ...
        titleToolbar.text="Scanned Images"
    }
    ...
    fun intData() {
        this.adapter = AlbumsPhotoAdapter(this, ScanImagesActivty.mAlbumPhoto, this)
        ...
        folders.text="${ScanImagesActivty.mAlbumPhoto.size.toString()}\nFolders"
    }
