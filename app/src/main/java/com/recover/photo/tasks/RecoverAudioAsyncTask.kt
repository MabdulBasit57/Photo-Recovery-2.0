...
class RecoverAudioAsyncTask : AsyncTask<String?, Int?, String?> {
    private val TAG: String = javaClass.name
    var count: Int = 0
    var delete: Boolean = false
    private var listPhoto: ArrayList<AudioModel>
    ...
    constructor(
        context: Context,
        arrayList: ArrayList<AudioModel>,
        ...
        if (this.delete) {
            ...
            for (i3 in listPhoto.indices) {
                ...
                val file3 = File(
                    Utils.getPathSave(
                        context,
                        context.getString(R.string.restore_folder_path_audio)
                    )
                )
                ...
                sb.append(
                    Utils.getPathSave(
                        context2,
                        context2.getString(R.string.restore_folder_path_audio)
                    )
                )
